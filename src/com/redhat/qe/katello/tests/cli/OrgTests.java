...
public class OrgTests extends KatelloCliTestScript{
	...
	@Test(description = "List orgs - created", 
			dependsOnMethods={"test_createOrg"},groups={"cfse-cli","headpin-cli"}) // SAM 1.1 has error displaying non-ascii chars, remove from the list.
	...
	public void test_updateOrg(){
		...
		org.description = "Normal description" + org.description;
